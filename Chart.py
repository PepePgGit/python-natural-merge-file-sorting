...
class Chart:
    ...
    @staticmethod
    def disc_read_chart():
        data = np.genfromtxt("disc_read.csv", delimiter=",", names=["x", "y"])
    ...
    @staticmethod
    def disc_sum_chart():
        data1 = np.genfromtxt("disc_sum.csv", delimiter=",", names=["x", "y"])
        data2 = np.genfromtxt("disc_sum_theory.csv", delimiter=",", names=["x", "y"])
    ...
    @staticmethod
    def phase_chart():
        data1 = np.genfromtxt("phase.csv", delimiter=",", names=["x", "y"])
        data2 = np.genfromtxt("phase_theory.csv", delimiter=",", names=["x", "y"])
